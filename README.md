...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/lemminflect-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11342&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/lemminflect-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `lemminflect` can be installed with:

```
conda install lemminflect
```

It is possible to list all of the versions of `lemminflect` available on your platform with:
